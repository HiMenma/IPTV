#!/usr/bin/env python3
"""
Script to add PlaylistSidebarView.swift to the Xcode project
"""
...
# New file to add
filename = 'PlaylistSidebarView.swift'
group = 'Views'
