#!/usr/bin/env python3
"""
Script to add PlaylistRepository.swift to the Xcode project
"""
...
# New file to add
filename = 'PlaylistRepository.swift'
group = 'Services'
...
services_group_pattern = r"(A10000040 /\* Services \*/ = \{[^}]+children = \([^)]+)"
services_child = f"\t\t\t\t{file_id} /* {filename} */,"
content = re.sub(services_group_pattern, r"\1\n" + services_child, content)
