#!/usr/bin/env python3
"""
Script to add Favorite.swift to the Xcode project
"""
...
# New file to add
filename = 'Favorite.swift'
group = 'Models'

# Generate unique IDs (using a high base to avoid conflicts)
file_id = "A1000020D"
build_id = "A100002DD"
...
models_group_pattern = r"(A10000050 /\* Models \*/ = \{[^}]+children = \([^)]+)"
models_child = f"\t\t\t\t{file_id} /* {filename} */,"
content = re.sub(models_group_pattern, r"\1\n" + models_child, content)
