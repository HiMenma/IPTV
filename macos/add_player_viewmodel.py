#!/usr/bin/env python3
"""
Script to add PlayerViewModel.swift to the Xcode project
"""
...
# New file to add
filename = 'PlayerViewModel.swift'
group = 'ViewModels'
...
# Find the ViewModels group and add the file
viewmodels_group_pattern = r"(A10000030 /\* ViewModels \*/ = \{[^}]+children = \([^)]+)"
viewmodels_child = f"\t\t\t\t{file_id} /* {filename} */,"
content = re.sub(viewmodels_group_pattern, r"\1\n" + viewmodels_child, content)
